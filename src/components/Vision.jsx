...
const Vision = () => {
  return (
    ...
    >
      <div className="bg-[#303a73] text-white p-10 rounded-2xl shadow-2xl w-11/12 max-w-5xl text-center">
        <motion.h1
        ...
        >
          <Eye
            className="inline-block mr-2 text-[#ffff] animate-bounce text-4xl"
            size={32}
          />
          Our Vision
        </motion.h1>
        <motion.p
          ...
          className="text-lg text-justify text-[#fff] mb-8 "
        >
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <Target className="text-[#ffff] mx-auto animate-pulse" size={48} />
        </motion.div>
      </div>
    </motion.div>
  );
