        ...
        <div className="max-w-3xl">
          <div className="  mt-0 transition-all duration-1000">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-2xl">
              Experience seamless and reliable billing services with our team of
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="max-w-3xl">
          <div className=" mt-0 transition-all duration-1000">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-2xl">
              BellClinix offers result-oriented, AI-powered RCM solutions
              turning complexity in clarity. Ensuring compliance and measurable
